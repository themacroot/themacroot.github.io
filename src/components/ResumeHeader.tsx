...
const ResumeHeader: React.FC<ResumeHeaderProps> = ({ className }) => {
  ...
  return (
    <header id="about" className={cn('pt-20 md:pt-24 pb-16 md:pb-24 noise-bg', className)}>
...
`}
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
          ...
          >
            <div className="terminal-box mb-8 p-4 brutal-shadow-green">
          ...
          <div 
            ...
            style={{ transform: `translateY(${scrollY * 0.05}px)` }}
          >
            <div className="terminal-box p-6 brutal-shadow-green">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mt-8">
                <div className="terminal-box brutal-shadow-green p-4">
